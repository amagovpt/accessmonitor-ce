...
const pt = {
  ...
  open_dropdown:
    'pressione para expandir a nossa lista de aplicações e sítios web',
  close_dropdown:
    'pressione para comprimir a nossa lista de aplicações e sítios web',
  ...
  accessibilityLink1:
    'DL n.º 83/2018 – acessibilidade da Web e das aplicações móveis',
  accessibilityLink2: 'Gerar a Declaração de acessibilidade',
  accessibilityLink3: 'Validador AccessMonitor',
  usabilityText:
    'Recursos, ferramentas e boas práticas para melhorar a usabilidade e a experiência de utilização dos serviços digitais.',
  ...
  badgeText:
    'Selo de excelência que premeia as boas práticas de acessibilidade e usabilidade nos sítios Web dos serviços públicos.',
...
const en = {
  ...
  accessibilityText:
    'Dissemination, sharing and promotion of best accessibility practices for web content and mobile applications.',
  accessibilityLink1:
    'DL n.º 83/2018 - accessibility of the web and mobile applications',
  accessibilityLink2: 'Generate the Accessibility Statement',
  accessibilityLink3: 'AccessMonitor Validator',
  usabilityText:
    'Resources, tools and good practices to improve the usability and experience of using digital services.',
  ...
  badgeText:
    'Seal of excellence that rewards good accessibility and usability practices on public service websites.',
    ...
    >
      <div className="skip-to-content">
        <div className="container">
          <a
            className="skip-to-content-link d-flex align-items-center ama-typography-action-small py-2 px-3 my-3"
            href="#content"
          >
