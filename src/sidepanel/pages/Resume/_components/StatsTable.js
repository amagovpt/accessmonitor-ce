        ...
        <tbody>
          ...
          <tr>
            <th scope="row" className="border_right">
              <div className="acceptable_container">
                <div className="icon_and_text">
                  <span className="heading_totals">
                    Total ({data?.data?.metadata?.count_results})
                  </span>
                </div>
              </div>
            ...
            {/* DESKTOP */}
            <td className="border_right body_text desk_row">{sumValueA}</td>
            <td className="border_right body_text desk_row">{sumValueAA}</td>
            <td className="border_right body_text desk_row">{sumValueAAA}</td>
          </tr>
        </tbody>
      </table>
    </>
