...
const config = {
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        {
          from: 'node_modules/@qualweb/qw-page/dist/qw-page.bundle.js',
          to: 'qwPage.js',
        },
        {
          from: 'node_modules/@qualweb/util/dist/__webpack/util.bundle.js',
          to: 'util.js',
        },
        {
          from: 'node_modules/@qualweb/act-rules/dist/__webpack/act.bundle.js',
          to: 'act.js',
        },
        {
          from: 'node_modules/@qualweb/wcag-techniques/dist/__webpack/wcag.bundle.js',
          to: 'wcag.js',
        },
        {
          from: 'node_modules/@qualweb/best-practices/dist/__webpack/bp.bundle.js',
          to: 'bp.js',
        },
        ...
        { from: 'src/sidepanel/highlight.js', to: 'sidepanel/highlight.js' },
        {
          ...
          transform: { transformer: transformHtml, cache: true },
        },
